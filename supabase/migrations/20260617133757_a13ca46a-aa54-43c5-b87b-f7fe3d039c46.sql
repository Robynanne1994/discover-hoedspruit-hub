...
DROP FUNCTION IF EXISTS public.apply_moderation_action(uuid, text, text, integer, text, text);
...
REVOKE ALL ON FUNCTION public.apply_moderation_action(uuid, text, text, integer, text, text, uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.apply_moderation_action(uuid, text, text, integer, text, text, uuid) TO authenticated;
