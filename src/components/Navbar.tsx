      ...
      <div className="container-wide px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div ref={exploreRef} className="relative">
              ...
              {exploreOpen &&
              <div className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-56 bg-card border border-border rounded-2xl shadow-card py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                  {categories?.map((cat) =>
                <Link
                  key={cat.id}
                  to={`/category/${cat.id}`}
        ...
        <div className="md:hidden pb-6 space-y-1">
          ...
          <div className="pl-4 space-y-1 pb-2">
              ...
              onClick={() => {setIsOpen(false);setMobileEventsOpen(false);goToEvents();}}>
