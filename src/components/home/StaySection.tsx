...
const StaySection = () => {
  ...
  return (
    <section className="py-4">
      <SectionHeader title={title || "Places to Stay"} actionLabel="See all" actionHref="/category/cef1c5ad-b199-41c9-bc8a-5834703a953a" /> title={title || "Places to Stay"} actionLabel="See all" actionHref="/category/cef1c5ad-b199-41c9-bc8a-5834703a953a" /> />
