...
const ShopSection = () => {
  ...
  return (
    <section className="py-4">
      <SectionHeader title={title || "Where to Shop"} actionLabel="See all" actionHref="/category/7b335bd5-3ce9-4ecd-92bd-3735804402b8" /> title={title || "Where to Shop"} actionLabel="See all" actionHref="/category/7b335bd5-3ce9-4ecd-92bd-3735804402b8" /> />
