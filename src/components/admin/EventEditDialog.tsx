...
const FIELDS = [
  ...
  "tag", "sub_tag_1", "sub_tag_2", "image_url", "detail_image_url", "homepage_image_url", "recurrence", "performances", "price", "included", "notes", "booking_link", "booking_link_label",
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[calc(100vw-1rem)] sm:max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-3 py-2">
          ...
          <div><Label>Card Cover Image <span className="text-xs text-muted-foreground font-normal">(1:1 square — matches the events list card)</span></Label><ImageUpload bucket="listing-images" value={form.image_url || ""} onChange={(url) => set("image_url", url)} aspect={1} /></div>
