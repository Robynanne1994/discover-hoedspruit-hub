...
const PolicyPageLayout = ({ title, lastUpdated, sections }: PolicyPageLayoutProps) => {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#E6E0CC", paddingBottom: "var(--nav-clearance)" }}>
      {/* Back button */}
      ...
      <div style={{ padding: "28px 24px 0" }}>
        <h1 style={{ fontSize: 40, fontWeight: 550, textTransform: "none", lineHeight: 0.95, letterSpacing: -0.5, color: "#0a0a0a", margin: 0 }}>
          {title}
        </h1>
