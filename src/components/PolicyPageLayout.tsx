      ...
      <div style={{ padding: "0 20px" }}>
        {sections.map((section, i) => (
          <div key={i} style={{ marginTop: i === 0 ? 0 : 32 }}>
            <h2 style={{ fontFamily: "'Bricolage Grotesque', 'Helvetica Neue', Helvetica, Arial, sans-serif", fontSize: 16, fontWeight: 800, color: "#0a0a0a", textTransform: "none", letterSpacing: 0, margin: 0, marginBottom: 14 }}>
              {section.heading}
            </h2>
