...
const APP_LINK_OPTIONS: { group: string; items: { label: string; path: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Terms of Use", path: "https://hellohoedspruit.co/legal/terms-of-use" },
      { label: "Privacy Policy", path: "https://hellohoedspruit.co/legal/privacy-policy" },
      { label: "Cookie Policy", path: "https://hellohoedspruit.co/legal/cookie-policy" },
      { label: "Community Guidelines", path: "https://hellohoedspruit.co/legal/community-guidelines" },
    ],
  },
];
