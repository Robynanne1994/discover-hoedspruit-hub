        ...
        <div className="flex flex-wrap gap-2">
          ...
          <DialogContent className="max-w-[calc(100vw-1rem)] sm:max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); upsert.mutate(form); }}>
              ...
              <div className="space-y-2"><Label>Card Cover Image <span className="text-xs text-muted-foreground font-normal">(1:1 square — matches the events list card)</span></Label><ImageUpload bucket="listing-images" value={form.image_url} onChange={(v) => setForm({ ...form, image_url: v })} aspect={1} /></div>
