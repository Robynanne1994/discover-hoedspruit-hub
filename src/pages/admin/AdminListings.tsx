    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6 lg:mb-8">
        ...
        <div className="flex flex-wrap gap-2">
          <Button variant="outline" className="gap-2 bg-stone-700 text-slate-100 border-gray-950" onClick={() => navigate("/admin/import")}>
                ...
                {selectedCatIds.length > 0 && (
                  <div>
                    ...
                    {showNewSub ? (
                      ...
                      <Button type="button" variant="ghost" size="sm" className="mt-2 h-8 px-2 gap-1 border-gray-950 opacity-100 bg-orange-300" onClick={() => setShowNewSub(true)}>
