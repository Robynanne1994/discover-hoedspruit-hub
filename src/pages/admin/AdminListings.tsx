...
const AdminListings = () => {
  ...
  const openEdit = (l: Listing) => {
    ...
    setForm({
      ...
      primary_product_categories: (l as any).primary_product_categories ?? [],
      product_categories: (l as any).product_categories ?? [],
      ...
      min_nights: (l as any).min_nights ?? null,
                    ...
                    <div className={ADMIN_FIELD_GRID}>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setForm({ ...form, min_nights: e.target.value ? parseInt(e.target.value, 10) : null })}
                          placeholder="e.g. 2"
                        />
                      </div>
