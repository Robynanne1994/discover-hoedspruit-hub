                ...
                {isRestaurantType && (
                  <div className="border-t border-border pt-4 mt-2 space-y-4">
                    ...
                    {[
                      ...
                      const CUISINE_EXCLUDE = new Set(["light meals", "pub grub", "breakfast", "farm to fork", "farm food", "bak contemporary", "health bowls", "health food", "fried chicken", "farm-to-fork", "contemporary", "smoked meats"]);
