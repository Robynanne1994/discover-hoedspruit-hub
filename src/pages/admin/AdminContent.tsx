...
const AdminContent = () => {
  ...
  return (
    <div>
      <h1 className="font-heading text-2xl lg:text-3xl font-bold text-foreground mb-6 lg:mb-8">Site Content</h1>

      <div className="space-y-8 max-w-2xl">
        {/* Header / Logo */}
        <div className="bg-card border border-border rounded-xl p-6 space-y-4">
          <h2 className="font-heading text-xl font-medium text-slate-950">Header / Logo</h2>
          <div>
        ...
        {/* Hero Image */}
        <div className="bg-card border border-border rounded-xl p-6 space-y-4">
          <h2 className="font-heading text-xl font-medium text-slate-950">Homepage Hero Image</h2>
        ...
        {/* Advertise Section */}
        <div className="bg-card border border-border rounded-xl p-6 space-y-4">
          <h2 className="font-heading text-xl font-medium text-slate-950">Advertise Section</h2>
        ...
        {/* Footer Section */}
        <div className="bg-card border border-border rounded-xl p-6 space-y-4">
          <h2 className="font-heading text-xl font-medium text-slate-950">Footer</h2>
