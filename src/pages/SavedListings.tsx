                    ...
                    >
                      <div style={{ width: "100%", aspectRatio: "16/10", background: "#f0f0f0", position: "relative" }}>
                        ...
                        <div className="absolute bottom-0 left-0 right-0" style={{ padding: 16 }}>
                          <h3 style={{ fontFamily: "'Helvetica World', Helvetica, Arial, sans-serif", fontSize: 18, fontWeight: 500, color: "#FFFFFF", textTransform: "capitalize", lineHeight: 1.2, letterSpacing: "0.01em", marginBottom: 4 }}>{detail.title?.toLowerCase()}</h3>
