  ...
  return (
    <div style={{ minHeight: "100vh", background: "#ebebeb", paddingBottom: 100 }}>
      ...
      <div style={{ padding: "0 24px", marginBottom: 20 }}>
        <h2 style={{ fontWeight: 400, fontSize: 22, color: "#2b2420", textTransform: "uppercase", letterSpacing: 0.5, margin: 0 }}>GET IN TOUCH</h2>
      </div>
      ...
      <div style={{ padding: "0 24px", marginBottom: 28 }}>
        {submitted ? (
          <div style={{ ...cardStyle, padding: 32, textAlign: "center" }}>
            ...
            <div style={{ fontWeight: 400, fontSize: 18, color: "#2b2420", textTransform: "uppercase", marginBottom: 8 }}>Thanks for your interest!</div>
