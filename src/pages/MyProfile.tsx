  ...
  const { data: savedSpecials } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data: specials } = await supabase
        .from("specials")
        .select("id, title, title_override, image_url, saved_image_url, business_name, valid_until, deal_label, tag, card_footer_text, price, price_label, original_price, savings")
        .in("id", ids);
