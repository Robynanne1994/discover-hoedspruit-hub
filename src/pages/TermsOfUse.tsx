...
const sections = [
  ...
  { heading: "Who We Are", body: "Hello Hoedspruit is a local directory and lifestyle app for Hoedspruit, South Africa. It is operated by Robyn Dawes. For any questions about these terms, contact us at admin@hellohoedspruit.co." },
  ...
  { heading: "Contact", body: "If you have questions about these terms, please contact us at admin@hellohoedspruit.co." },
];
